# Portfolio Evidence Release 0.2.0

## Added

- employer and organization pathways on the homepage
- AI Workflow Enablement services page and controlled-pilot offer
- working Meeting Intelligence public MVP
- synthetic source, reference output, acceptance tests, governance boundary, and administrator runbook
- proof-first AI Workflow Enablement case study
- evidence, privacy, maturity, and claim standard
...
- reorganized the Work page around three flagship proofs
- corrected SmartGrocer from product concept to working demo MVP
- removed the email request barrier from résumé access
...
This release intentionally uses synthetic, sanitized, reconstructed, or representative material. It does not publish confidential employer records or sensitive personal information.
